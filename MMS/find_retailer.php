...
<head>
	<meta charset="utf-8">
	<title>MMS Retailers - Find Retailer</title>
			...
			<header> 
				...
				<hgroup>
					...
					<h2>type in conditions</h2>
                        ...
                        <form method="post" action="search_retailer.php">
			<div class="content no-padding timeline">
				<div class="tl-post">
					<span class="icon">&#59170;</span>
                                        <p>ID: <input name="retailer_id" type="text" value=""/></p>
				</div>
				<div class="tl-post">
					<span class="icon">&#59148;</span>
					<p>Name: <input name="retailer_name" type="text" value=""/></p>
				</div>
                            <div align="right">
                                <button name="search_retailer" class="green" style = "margin:0 0 15px 0">Search</button> <button name="reset" class="">Reset</button>
                                </div>
			</div>
                            </form>
		</section>
