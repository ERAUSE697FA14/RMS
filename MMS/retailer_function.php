...
<head>
	<meta charset="utf-8">
	<title>MMS Retailers - Functions</title>
	...
	<div class="widget-container">
		<section class="widget small">
			<header> 
				...
				<hgroup>
					<h1>New Retailer</h1>
					<h2>redirect to new retailer page</h2>
				</hgroup>
			</header>
                    <div class="content">
				<section class="stats-wrapper">
					<div class="stats" style = "width: 100%">
                        <form method="post" action="new_retailer.php">
                                <button name="new_retailer" class="green" style = "margin:0 0 15px 0">New Retailer</button>
                        </form>
					</div>
				</section>
			</div>
		...
		<section class="widget 	small">
			<header> 
				...
				<hgroup>
					<h1>Find Retailer</h1>
					<h2>redirect to find retailer page</h2>
				</hgroup>
			</header>
			<div class="content">
				<section class="stats-wrapper">
					<div class="stats" style = "width: 100%">
                        <form method="post" action="find_retailer.php">
                            <button name="find_retailer" class="green" style = "margin:0 0 15px 0">Find Retailer</button>
                        </form>
					</div>
				</section>
			</div>
