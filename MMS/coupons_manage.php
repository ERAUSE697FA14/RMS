...
<head>
	<meta charset="utf-8">
	<title>MMS Rewards - Coupons Management</title>
	...
	<div class="widget-container">
		<section class="widget small">
			...
			<div class="content no-padding timeline">
				<div class="tl-post">
					<span class="icon">&#127915;</span>
                                        <p>Coupon ID: <input name="coupon_id" type="text" value=""/></p>
				</div>
				<div class="tl-post">
					<span class="icon">&#128100;</span>
					<p>User ID: <input name="user_id" type="text" value=""/></p>
                            ...
                            <div align="right">
                                <button name="search_coupon" class="green" style = "margin:0 0 15px 0">Search</button> <button name="reset" class="">Reset</button>
                                </div>
			</div>
                            </form>
		</section>
