...
if(isset($_POST['edit'])){
    if(!empty($_POST['selectedMedia'])) {
            $postSelectedMedia = $_POST['selectedMedia'];
            session_start();
            $_SESSION['selectedMedia'] = $postSelectedMedia;
            $editMediaPath = '../MMS/edit_media.php';
            header("Location:".$editMediaPath);
}
}
?>
