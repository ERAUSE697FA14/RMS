		...
		<section class="widget small">
			<header> 
				...
				<hgroup>
					...
					<h2>redirect to redundant database page</h2>
				</hgroup>
			</header>
                    <div class="content">
				<section class="stats-wrapper">
					<div class="stats" style = "width: 100%">
                        <form method="post" action="redundant_database.php">
                                <button name="redundant_database" class="green" style = "margin:0 0 15px 0">Redundant Database</button>
                        </form>
					</div>
				</section>
			</div>
		...
		<section class="widget 	small">
			<header> 
				...
				<hgroup>
					...
					<h2>redirect to backup and restore page</h2>
				</hgroup>
			</header>
			<div class="content">
				<section class="stats-wrapper">
					<div class="stats" style = "width: 100%">
                        <form method="post" action="backup_restore.php">
                            <button name="backup_restore" class="green" style = "margin:0 0 15px 0">Backup & Restore</button>
                        </form>
					</div>
				</section>
			</div>
